...
- `BookStatistics` рассчитывает и отображает сводную статистику библиотеки.
...
- `BooksStatsPage` является самостоятельной страницей статистики всей книжной библиотеки.
